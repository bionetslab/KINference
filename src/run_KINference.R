...
parser$add_argument("--x1.path", type='character', default=NA,
   help="Path to the tab-separeted intensity measurement file of x1. [default %(default)s]")
parser$add_argument("--x0.path", type='character', default=NA,
   help="Path to the tab-separeted intensity measurement file of x0. [default %(default)s]")
parser$add_argument("--f.path", type='character', default=NA,
 help="Path to the tab-separeted intensity vector file. [default %(default)s]")
parser$add_argument("output.path", type="character", default='results', 
   help="Output path. [default %(default)s]")
parser$add_argument("output.id", type="character", default='key', 
 help="Output id. [default %(default)s]")
parser$add_argument("paired_samples", action='store_false', default = FALSE, 
 help="Bool variable that indicates if the samples are paired. Influences the computation of the log2-transformed intensities. See the paper for a more detailed explanation [default %(default)s]")
parser$add_argument("--alpha", default=0.9, default="double",
   help = "Threshold for the baseline KIN percentile scoring [default \"%(default)s\"]")
parser$add_argument("--n", default=15, type="integer",
   help="Threshold for the number of edges in the baseline KIN [default %(default)s]")
parser$add_argument("--beta", default=0.4, type="double",
   help="Threshold for the FS filter [default %(default)s]")
parser$add_argument("--gamma", default=1.0, type="double",
   help="Threshold for the DIFF filter [default %(default)s]")
parser$add_argument("--delta", default=0.8, type="double",
   help="Threshold for the CORR filter [default %(default)s]")
 parser$add_argument("--epsilon", default=0.05, type="double",
   help="Threshold for the significance test of the CORR filter [default %(default)s]")
parser$add_argument("--m", default=10, type="integer",
   help="Threshold for the number of samples needed for correlation calculation [default %(default)s]")
